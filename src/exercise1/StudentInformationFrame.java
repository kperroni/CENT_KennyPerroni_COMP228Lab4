...
public class StudentInformationFrame extends JFrame implements ActionListener, ItemListener, MouseListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		//Checking which check boxes were selected and assigning the value to otherActivities variable
		...
		//Checking which radio button was selected and assigning the value to program variable
